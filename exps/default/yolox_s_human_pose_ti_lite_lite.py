...
class Exp(MyExp):
    ...
    def get_model(self):
        from yolox.models import YOLOX, YOLOPAFPN, YOLOXHeadKPTSLite
        ...
        if getattr(self, "model", None) is None:
            ...
            head = YOLOXHeadKPTSLite(self.width, in_channels=in_channels, act=self.act, num_kpts=self.num_kpts, default_sigmas=self.default_sigmas)
